module.exports = function (router) {
    ...
    router.get('/service-access/v10/service-access-nhs', function (req, res) {
        ...
        // re-render the page along with the parameter
        res.render('service-access/v10/service-access-nhs', {vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, hidehead: hidehead, loggedin: loggedin }, function(err, html) {
            res.send(html)
        })
    })
