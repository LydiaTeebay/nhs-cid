module.exports = function (router) {
    router.get('/service-access/v13/service-access-nam-error-502', function (req, res) {
        ...
        res.render('service-access/v13/service-access-nam-error-502', { serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, result: result, reason: reason }, function(err, html) {
            res.send(html)
        })
    })
