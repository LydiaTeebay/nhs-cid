module.exports = function (router) {
    ...
    router.get('/service-access/v24/service-access-challenge-1', function (req, res) {
    ...
    router.get('/service-access/v23/service-access-challenge-1', function (req, res) {
        // pull in the url parameters
        var uplift = req.param('uplift')
        var vouched = req.param('vouch')
        var service = req.param('service')
    ...
    router.get('/service-access/v20/service-access-challenge-1', function (req, res) {
        // pull in the url parameters
        var vouched = req.param('vouch')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
    ...
    router.get('/service-access/v19/service-access-challenge-1', function (req, res) {
        // pull in the url parameters
        var vouched = req.param('vouch')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
    ...
    router.get('/service-access/v18/service-access-challenge-1', function (req, res) {
        // pull in the url parameters
        var vouched = req.param('vouch')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
    ...
    router.get('/service-access/v17/service-access-challenge-1', function (req, res) {
        // pull in the url parameters
        var vouched = req.param('vouch')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
    ...
    router.get('/service-access/v16/service-access-challenge-1', function (req, res) {
        // pull in the url parameters
        var vouched = req.param('vouch')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
    ...
    router.get('/service-access/v15/service-access-challenge-1', function (req, res) {
        // pull in the url parameters
        var vouched = req.param('vouch')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
    ...
    router.get('/service-access/v14/service-access-challenge-1', function (req, res) {
        // pull in the url parameters
        var vouched = req.param('vouch')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
    ...
    router.get('/service-access/demo/service-access-challenge-1', function (req, res) {
        // pull in the url parameters
        var vouched = req.param('vouch')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
    ...
    router.get('/service-access/v13/service-access-challenge-1', function (req, res) {
        // pull in the url parameters
        var vouched = req.param('vouch')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
