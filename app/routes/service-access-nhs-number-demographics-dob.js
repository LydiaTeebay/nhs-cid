module.exports = function (router) {
    ...
    router.get('/service-access/v11/service-access-nhs-number-demographics-dob', function (req, res) {
        ...
        // re-render the page along with the parameter
        res.render('service-access/v11/service-access-nhs-number-demographics-dob', { vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, hidehead: hidehead, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy }, function(err, html) {
            res.send(html)
        })
    })
