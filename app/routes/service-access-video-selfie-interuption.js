module.exports = function (router) {
    ...
    router.get('/service-access/v24/service-access-video-selfie-interuption', function (req, res) {
        ...
        res.render('service-access/v24/service-access-video-selfie-interuption', { manual: manual, uplift: uplift, vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, hidehead: hidehead, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, devMode: devMode, returnUrl: returnUrl, idType: idType }, function(err, html) {
            res.send(html)
        })
    })
