...
module.exports = function (router) {
    router.get('/service-access/nhs-number-error-2', function (req, res) {
        ...
        res.render('service-access/nhs-number-error-2', { service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum }, function(err, html) {
            res.send(html)
        })
    })

    router.post('/service-access/nhs-number-error-2', function (req, res) {
        console.log("post")
