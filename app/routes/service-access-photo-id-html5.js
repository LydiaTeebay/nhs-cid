module.exports = function (router) {
    ...
    router.get('/service-access/v24/service-access-photo-id-html5', function (req, res) {
        ...
        res.render('service-access/v24/service-access-photo-id-html5', { manual: manual, uplift: uplift, vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, changetomobile: changetomobile, mobile: isMobile, pinCode: pinCode, hidehead: hidehead, idType: idType }, function(err, html) {
            res.send(html)
        })
    })

    router.get('/service-access/v23/service-access-photo-id-html5', function (req, res) {
        // pull in the url parameters
        var uplift = req.param('uplift')
        var vouched = req.param('vouch')
        var service = req.param('service')
        ...
        var isMobile = req.useragent.isMobile
        // re-render the page along with the parameter
        res.render('service-access/v23/service-access-photo-id-html5', { manual: manual, uplift: uplift, vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, changetomobile: changetomobile, mobile: isMobile, pinCode: pinCode, hidehead: hidehead, idType: idType }, function(err, html) {
            res.send(html)
        })
    })
