module.exports = function (router) {
    ...
    router.get('/service-access/v24/service-access-iproov-enrolment', function (req, res) {
    ...
    router.get('/service-access/v23/service-access-iproov-enrolment', function (req, res) {
        ...
        var manual = req.param('manual')
        // re-render the page along with the parameter
        res.render('service-access/v23/service-access-iproov-enrolment', { manual: manual, uplift: uplift, vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, idType: idType, changetomobile: changetomobile, mobile: isMobile, pinCode: pinCode, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, iproovTokenFailReason: iproovTokenFailReason, iproovEnrolFailReason: iproovEnrolFailReason, iproovFailReason: iproovFailReason }, function(err, html) {
            res.send(html)
        })
    })
    ...
    router.get('/service-access/v21/service-access-iproov-enrolment', function (req, res) {
        // pull in the url parameters
        var vouched = req.param('vouch')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
        ...
        var pyiSecondAttempt = req.param('pyiSecondAttempt')
        // re-render the page along with the parameter
        res.render('service-access/v21/service-access-iproov-enrolment', { vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, idType: idType, changetomobile: changetomobile, mobile: isMobile, pinCode: pinCode, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, iproovTokenFailReason: iproovTokenFailReason, iproovEnrolFailReason: iproovEnrolFailReason }, function(err, html) {
            res.send(html)
        })
    })
}
