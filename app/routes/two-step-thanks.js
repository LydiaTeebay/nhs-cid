module.exports = function (router) {
  router.get('/create-account/two-step-thanks', function (req, res) {
    ...
    router.get('/create-account/v10/two-step-thanks', function (req, res) {
        ...
        var poluser = req.param('poluser')
        // re-render the page along with the parameter
        res.render('create-account/v10/two-step-thanks', {reason: theReason, vouch: vouched, service: service, serviceName: serviceName, poluser: poluser }, function(err, html) {
            res.send(html)
        })
    })
