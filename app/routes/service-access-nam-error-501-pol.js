module.exports = function (router) {
    router.get('/service-access/v16/service-access-nam-error-501-pol', function (req, res) {
        ...
        res.render('service-access/v16/service-access-nam-error-501-pol', { serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, result: result, reason: reason }, function(err, html) {
            res.send(html)
        })
    })
