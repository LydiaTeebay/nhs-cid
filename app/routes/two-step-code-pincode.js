...
module.exports = function (router) {
  router.get('/create-account/two-step-code-pincode', function (req, res) {
        ...
        res.render('create-account/two-step-code-pincode', {reason: theReason, vouch: vouched, service: service, serviceName: serviceName, terms: terms, resend: resend, mobileNum: mobileNum, emailAddress: emailAddress, hidehead: hidehead }, function(err, html) {
            res.send(html)
        })
    })
    ...
    router.get('/create-account/mvp/two-step-code-pincode', function (req, res) {
        ...
        // re-render the page along with the parameter
        res.render('create-account/mvp/two-step-code-pincode', {reason: theReason, vouch: vouched, service: service, serviceName: serviceName, terms: terms, resend: resend, mobileNum: mobileNum, emailAddress: emailAddress, hidehead: hidehead }, function(err, html) {
            res.send(html)
        })
    })
