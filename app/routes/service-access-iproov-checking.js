module.exports = function (router) {
    ...
    router.get('/service-access/v24/service-access-iproov-checking', function (req, res) {
    ...
    router.get('/service-access/v23/service-access-iproov-checking', function (req, res) {
        ...
        var manual = req.param('manual')
        // re-render the page along with the parameter
        res.render('service-access/v23/service-access-iproov-checking', { manual: manual, uplift: uplift, vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, idType: idType, changetomobile: changetomobile, mobile: isMobile, pinCode: pinCode, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, iproovFailReason: iproovFailReason, iProovThirdAttempt: iProovThirdAttempt, pyiSecondAttempt: pyiSecondAttempt, iproovFailReason: iproovFailReason }, function(err, html) {
            res.send(html)
        })
    })
