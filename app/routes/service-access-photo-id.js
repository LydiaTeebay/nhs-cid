module.exports = function (router) {
    ...
    router.get('/service-access/v10/service-access-photo-id', function (req, res) {
        ...
        var hidehead = req.param('hidehead')
        // re-render the page along with the parameter
        res.render('service-access/v10/service-access-photo-id', {vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, hidehead: hidehead }, function(err, html) {
            res.send(html)
        })
    })
