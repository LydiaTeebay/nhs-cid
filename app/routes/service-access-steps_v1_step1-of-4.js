module.exports = function (router) {
    ...
    router.get('/service-access/v24/service-access-steps_v1_step1-of-4', function (req, res) {
        ...
        res.render('service-access/v24/service-access-steps_v1_step1-of-4', { testing: testing, manual: manual, uplift: uplift, vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, hidehead: hidehead, poluser: poluser, loggedin: loggedin, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, devMode: devMode, returnUrl: returnUrl }, function(err, html) {
            res.send(html)
        })
    })   
