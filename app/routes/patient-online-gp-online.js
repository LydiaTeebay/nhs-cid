module.exports = function (router) {
  router.get('/patient-online/patient-online-gp-online', function (req, res) {
    ...
    router.get('/patient-online/v9/patient-online-gp-online', function (req, res) {
        ...
        res.render('patient-online/v9/patient-online-gp-online', { serviceName: serviceName, hidehead: hidehead, service: service, system: system, surgery: surgery }, function(err, html) {
            res.send(html)
        })
    })
