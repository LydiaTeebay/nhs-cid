...
module.exports = function (router) {
    router.get('/create-account/v22/create-password', function (req, res) {
        ...
        res.render('create-account/v22/create-password', { vouch: vouched, service: service, serviceName: serviceName, hidehead: hidehead, poluser: poluser, devMode: devMode, returnUrl: returnUrl, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, manual: manual }, function(err, html) {
            res.send(html)
        })
    })
    router.post('/create-account/v22/create-password', function (req, res) {
        ...
        if (vouched === 'yes') {
            res.redirect('/create-account/v22/two-step-code?vouch=yes')
            return
        }
        res.redirect('/create-account/v22/check-email?terms=yes&emailAddress=' + emailAddress + '&mobileNum=' + mobileNum + '&service=' + service + '&serviceName=' + serviceName + '&hidehead=' + hidehead + '&devMode=' + devMode + '&returnUrl=' + returnUrl + '&poluser=' + poluser + '&lsId=' + lsId + '&lsAccess=' + lsAccess + '&lsStudy=' + lsStudy + '&manual=' + manual )
    })

    router.get('/create-account/v21/create-password', function (req, res) {
        // pull in the url parameters
        var vouched = req.param('vouch')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
        ...
        // re-render the page along with the parameter
        res.render('create-account/v21/create-password', { vouch: vouched, service: service, serviceName: serviceName, hidehead: hidehead, poluser: poluser, devMode: devMode, returnUrl: returnUrl, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, manual: manual }, function(err, html) {
            res.send(html)
        })
    })
    router.post('/create-account/v21/create-password', function (req, res) {
        var emailAddress = req.body.emailAddress
        var mobileNum = req.body.mobileNum
        var service = req.param('service')
        var serviceName = req.param('serviceName')
        ...
        if (vouched === 'yes') {
            res.redirect('/create-account/v21/two-step-code?vouch=yes')
            return
        }
        res.redirect('/create-account/v21/check-email?terms=yes&emailAddress=' + emailAddress + '&mobileNum=' + mobileNum + '&service=' + service + '&serviceName=' + serviceName + '&hidehead=' + hidehead + '&devMode=' + devMode + '&returnUrl=' + returnUrl + '&poluser=' + poluser + '&lsId=' + lsId + '&lsAccess=' + lsAccess + '&lsStudy=' + lsStudy + '&manual=' + manual )
    })
