...
module.exports = function (router) {
    router.get('/service-access/nhs-number-error', function (req, res) {
        ...
        res.render('service-access/nhs-number-error', { service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum }, function(err, html) {
            res.send(html)
        })
    })
