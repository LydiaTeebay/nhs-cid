module.exports = function (router) {
    ...
    router.get('/patient-online/v24/patient-online-nam-error-nhsmismatch', function (req, res) {
        ...
        res.render('patient-online/v24/patient-online-nam-error-nhsmismatch', { testing: testing, uplift: uplift, serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy }, function(err, html) {
            res.send(html)
        })
    })

    router.get('/patient-online/v22/patient-online-nam-error-nhsmismatch', function (req, res) {
        var uplift = req.param('uplift')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
        var hidehead = req.param('hidehead')
        ...
        var lsAccess = req.param('lsAccess')
        var lsStudy = req.param('lsStudy')
        res.render('patient-online/v22/patient-online-nam-error-nhsmismatch', { uplift: uplift, serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy }, function(err, html) {
            res.send(html)
        })
    })
