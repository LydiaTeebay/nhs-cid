module.exports = function (router) {
    router.get('/patient-online/v22/patient-online-nam-error-nhsmismatch', function (req, res) {
        ...
        res.render('patient-online/v22/patient-online-nam-error-nhsmismatch', { serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy }, function(err, html) {
            res.send(html)
        })
    })
