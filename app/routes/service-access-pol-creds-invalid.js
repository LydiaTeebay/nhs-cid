module.exports = function (router) {
    ...
    router.get('/service-access/v22/service-access-pol-creds-invalid', function (req, res) {
        ...
        res.render('service-access/v22/service-access-pol-creds-invalid', { serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, result: result, reason: reason }, function(err, html) {
            res.send(html)
        })
    })
