module.exports = function (router) {
    router.get('/eRedbook/erb-child-import', function (req, res) {
        ...
        let child1name = process.env.CHILD1_NAME
        ...
        res.render('eRedbook/erb-child-import', { service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, verified: verified }, function(err, html) {
            res.send(html)
        })
    })
