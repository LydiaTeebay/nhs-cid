module.exports = function (router) {
    router.get('/emails/v5/email-account-created', function (req, res) {
        ...
        res.render('emails/v5/email-account-created', { reason: theReason, passwordChange: passwordChange, newUser: newUser, vouch: vouched, service: service, serviceName: serviceName, terms: terms, emailAddress: emailAddress, poluser: poluser, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy }, function(err, html) {
            res.send(html)
        })
    })
