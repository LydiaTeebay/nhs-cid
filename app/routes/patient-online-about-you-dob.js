module.exports = function (router) {
    router.get('/patient-online/v9/patient-online-about-you-dob', function (req, res) {
        ...
        res.render('patient-online/v9/patient-online-about-you-dob', { vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, hidehead: hidehead, system: system }, function(err, html) {
            res.send(html)
        })
    })
