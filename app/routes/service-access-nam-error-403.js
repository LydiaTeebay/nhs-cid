module.exports = function (router) {
    ...
    router.get('/service-access/v22/service-access-nam-error-403', function (req, res) {
        ...
        res.render('service-access/v22/service-access-nam-error-403', { serviceName: serviceName, hidehead: hidehead, service: service, devMode: devMode, returnUrl: returnUrl, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, result: result, reason: reason }, function(err, html) {
            res.send(html)
        })
    })
