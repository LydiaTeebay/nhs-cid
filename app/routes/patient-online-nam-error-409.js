module.exports = function (router) {
    router.get('/patient-online/v13/patient-online-nam-error-409', function (req, res) {
        ...
        res.render('patient-online/v13/patient-online-nam-error-409', { serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy }, function(err, html) {
            res.send(html)
        })
    })
