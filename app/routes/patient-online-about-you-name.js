module.exports = function (router) {
    ...
    router.get('/patient-online/v24/patient-online-about-you-name', function (req, res) {
    ...
    router.get('/patient-online/v23/patient-online-about-you-name', function (req, res) {
        ...
        var manual = req.param('manual')
        // re-render the page along with the parameter
        res.render('patient-online/v23/patient-online-about-you-name', { uplift: uplift, vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, system: system, result: result, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, manual: manual }, function(err, html) {
            res.send(html)
        })
    })
    ...
    router.get('/patient-online/v22/patient-online-about-you-name', function (req, res) {
        ...
        var manual = req.param('manual')
        // re-render the page along with the parameter
        res.render('patient-online/v22/patient-online-about-you-name', { uplift: uplift, vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, system: system, result: result, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, manual: manual }, function(err, html) {
            res.send(html)
        })
    })
