module.exports = function (router) {
  ...
  router.get('/create-account/v22/login-nhs-create', function (req, res) {
    var service = req.param('service')
    var serviceName = req.param('serviceName')
    ...
    res.render('create-account/v22/login-nhs-create', { serviceName: serviceName, service: service, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, manual: manual }, function(err, html) {
        res.send(html)
    })
})

    router.get('/create-account/v21/login-nhs-create', function (req, res) {
        var service = req.param('service')
        var serviceName = req.param('serviceName')
        var poluser = req.param('poluser')
        var hidehead = req.param('hidehead')
        ...
        var lsStudy = req.param('lsStudy')
        var manual = req.param('manual')
        res.render('create-account/v21/login-nhs-create', { serviceName: serviceName, service: service, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, manual: manual }, function(err, html) {
            res.send(html)
        })
    })

    router.get('/create-account/v20/login-nhs-create', function (req, res) {
        var service = req.param('service')
        var serviceName = req.param('serviceName')
        var poluser = req.param('poluser')
        var hidehead = req.param('hidehead')
        ...
        var lsStudy = req.param('lsStudy')
        var manual = req.param('manual')
        res.render('create-account/v20/login-nhs-create', { serviceName: serviceName, service: service, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, manual: manual }, function(err, html) {
            res.send(html)
        })
    })
