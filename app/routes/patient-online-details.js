module.exports = function (router) {
  router.get('/patient-online/patient-online-details', function (req, res) {
    ...
    router.get('/patient-online/v10/patient-online-details', function (req, res) {
        ...
        var serviceName = req.param('serviceName')
        var hidehead = req.param('hidehead')
        res.render('patient-online/v10/patient-online-details', { serviceName: serviceName, hidehead: hidehead, service: service }, function(err, html) {
            res.send(html)
        })
    })
    ...
    router.get('/patient-online/pb/patient-online-details', function (req, res) {
        ...
        var serviceName = req.param('serviceName')
        var hidehead = req.param('hidehead')
        res.render('patient-online/pb/patient-online-details', { serviceName: serviceName, hidehead: hidehead, service: service }, function(err, html) {
            res.send(html)
        })
    })
