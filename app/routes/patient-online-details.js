module.exports = function (router) {
  ...
  router.get('/patient-online/v24/patient-online-details', function (req, res) {
  ...
  router.get('/patient-online/v23/patient-online-details', function (req, res) {
    var uplift = req.param('uplift')
    var service = req.param('service')
    var serviceName = req.param('serviceName')
    var hidehead = req.param('hidehead')
    ...
    var drop = req.param('drop')
    var manual = req.param('manual')
    res.render('patient-online/v23/patient-online-details', { uplift: uplift, serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, hideBack: hideBack, drop: drop, manual: manual }, function(err, html) {
        res.send(html)
    })
})

  router.get('/patient-online/v22/patient-online-details', function (req, res) {
    var uplift = req.param('uplift')
    var service = req.param('service')
    var serviceName = req.param('serviceName')
    var hidehead = req.param('hidehead')
    ...
    var drop = req.param('drop')
    var manual = req.param('manual')
    res.render('patient-online/v22/patient-online-details', { uplift: uplift, serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, hideBack: hideBack, drop: drop, manual: manual }, function(err, html) {
        res.send(html)
    })
})

    router.get('/patient-online/v21/patient-online-details', function (req, res) {
        var service = req.param('service')
        var serviceName = req.param('serviceName')
        var hidehead = req.param('hidehead')
        var devMode = req.param('devMode')
        ...
        var drop = req.param('drop')
        var manual = req.param('manual')
        res.render('patient-online/v21/patient-online-details', { serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, hideBack: hideBack, drop: drop, manual: manual }, function(err, html) {
            res.send(html)
        })
    })

    router.get('/patient-online/v20/patient-online-details', function (req, res) {
        var service = req.param('service')
        var serviceName = req.param('serviceName')
        var hidehead = req.param('hidehead')
        var devMode = req.param('devMode')
        ...
        var drop = req.param('drop')
        var manual = req.param('manual')
        res.render('patient-online/v20/patient-online-details', { serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, hideBack: hideBack, drop: drop, manual: manual }, function(err, html) {
            res.send(html)
        })
    })
