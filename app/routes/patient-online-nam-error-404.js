module.exports = function (router) {
    router.get('/patient-online/v22/patient-online-nam-error-404', function (req, res) {
        ...
        res.render('patient-online/v22/patient-online-nam-error-404', { serviceName: serviceName, hidehead: hidehead, service: service, devMode: devMode, returnUrl: returnUrl, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy }, function(err, html) {
            res.send(html)
        })
    })
