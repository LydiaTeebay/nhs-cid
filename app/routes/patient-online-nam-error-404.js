module.exports = function (router) {
    ...
    router.get('/patient-online/v24/patient-online-nam-error-404', function (req, res) {
    ...
    router.get('/patient-online/v23/patient-online-nam-error-404', function (req, res) {
        var uplift = req.param('uplift')
        var service = req.param('service')
        var serviceName = req.param('serviceName')
        var hidehead = req.param('hidehead')
        ...
        var lsAccess = req.param('lsAccess')
        var lsStudy = req.param('lsStudy')
        res.render('patient-online/v23/patient-online-nam-error-404', { uplift: uplift, serviceName: serviceName, hidehead: hidehead, service: service, devMode: devMode, returnUrl: returnUrl, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy }, function(err, html) {
            res.send(html)
        })
    })
