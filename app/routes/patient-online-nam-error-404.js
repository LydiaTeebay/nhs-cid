module.exports = function (router) {
    router.get('/patient-online/v16/patient-online-nam-error-404', function (req, res) {
        ...
        res.render('patient-online/v16/patient-online-nam-error-404', { serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy }, function(err, html) {
            res.send(html)
        })
    })
