...
module.exports = function (router) {
    ...
    router.get('/create-account/v22/check-email-nudge', function (req, res) {
        ...
        res.render('create-account/v22/check-email-nudge', {reason: theReason, vouch: vouched, service: service, serviceName: serviceName, terms: terms, emailAddress: emailAddress, mobileNum: mobileNum, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, poluser: poluser, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy }, function(err, html) {
            res.send(html)
        })
    })
