...
module.exports = function (router) {
  router.get('/create-account/check-email-nudge', function (req, res) {
    ...
    res.render('create-account/check-email-nudge', {reason: theReason, vouch: vouched, service: service, serviceName: serviceName, terms: terms, emailAddress: emailAddress, mobileNum: mobileNum, hidehead: hidehead, poluser: poluser }, function(err, html) {
      res.send(html)
    })
  })
