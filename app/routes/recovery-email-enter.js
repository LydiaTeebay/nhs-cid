...
module.exports = function (router) {
  router.get('/account-recovery/recovery-email-enter', function (req, res) {
    ...
    res.render('account-recovery/recovery-email-enter', {reason: theReason, vouch: vouched, service: service, serviceName: serviceName, terms: terms, resend: resend, mobileNum: mobileNum, emailAddress: emailAddress, verified: verified, poluser: poluser, recoveryEmail: recoveryEmail, newMobileNum: newMobileNum, devMode: devMode, identityLevel0: identityLevel0, identityLevel9: identityLevel9 }, function(err, html) {
      res.send(html)
    })
  })
}