...
module.exports = function (router) {
    ...
    router.get('/service-access/v10/service-access-switchtomobile-waiting', function (req, res) {
        ...
        res.render('service-access/v10/service-access-switchtomobile-waiting', { vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, idType: idType, isMobile: isMobile, changetomobile: changetomobile, hidehead: hidehead }, function(err, html) {
            res.send(html)
        })
    })
    ...
    router.get('/service-access/pb/service-access-switchtomobile-waiting', function (req, res) {
        ...
        res.render('service-access/pb/service-access-switchtomobile-waiting', { vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, formerror: formerror, idType: idType, isMobile: isMobile, changetomobile: changetomobile, hidehead: hidehead }, function(err, html) {
            res.send(html)
        })
    })
