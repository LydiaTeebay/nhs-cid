module.exports = function (router) {
  router.get('/patient-online/patient-online-details-2', function (req, res) {
    ...
    router.get('/patient-online/v13/patient-online-details-2', function (req, res) {
        var service = req.param('service')
        var serviceName = req.param('serviceName')
        var hidehead = req.param('hidehead')
        ...
        res.render('patient-online/v13/patient-online-details-2', { serviceName: serviceName, hidehead: hidehead, devMode: devMode, returnUrl: returnUrl, service: service, poluser: poluser, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy }, function(err, html) {
            res.send(html)
        })
    })
