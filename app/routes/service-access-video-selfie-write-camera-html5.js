module.exports = function (router) {
    ...
    router.get('/service-access/v24/service-access-video-selfie-write-camera-html5', function (req, res) {
    ...
    router.get('/service-access/v23/service-access-video-selfie-write-camera-html5', function (req, res) {
        ...
        // re-render the page along with the parameter
        res.render('service-access/v23/service-access-video-selfie-write-camera-html5', { uplift: uplift, vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, changetomobile: changetomobile, mobile: isMobile, mobileOs: isMobileOs, mobileOsV: isMobileOsV, pinCode: pinCode, hidehead: hidehead, challenge: challenge, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, devMode: devMode, hideBack: hideBack, returnUrl: returnUrl, manual: manual }, function(err, html) {
            res.send(html)
        })
    })


    router.get('/service-access/v22/service-access-video-selfie-write-camera-html5', function (req, res) {
        // pull in the url parameters
        var uplift = req.param('uplift')
        var vouched = req.param('vouch')
        var service = req.param('service')
        ...
        // re-render the page along with the parameter
        res.render('service-access/v22/service-access-video-selfie-write-camera-html5', { uplift: uplift, vouch: vouched, service: service, serviceName: serviceName, emailAddress: emailAddress, mobileNum: mobileNum, changetomobile: changetomobile, mobile: isMobile, mobileOs: isMobileOs, mobileOsV: isMobileOsV, pinCode: pinCode, hidehead: hidehead, challenge: challenge, lsId: lsId, lsAccess: lsAccess, lsStudy: lsStudy, devMode: devMode, hideBack: hideBack, returnUrl: returnUrl, manual: manual }, function(err, html) {
            res.send(html)
        })
    })
